...
export DRILL_HEAP=${DRILL_HEAP:-"1G"}
export DRILLBIT_JAVA_OPTS="$DRILLBIT_JAVA_OPTS -Ddrill.disable_loopback_check=true -Djava.library.path=/opt/pam/"
